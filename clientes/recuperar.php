		...
		if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
			...
			if ($count > 0) {
				...
				$mail->msgHTML('Si usted solicito recuperar su contraseña, ingrese en el siguiente vinculo para restablecer su contraseña:
					<a href="http://localhost:8080/proyecto/clientes/nueva_contrasena.php?email='.$email.'&clave_temp='.$clave_temp.'">Click aquí</a>
					');
				if (!$mail->send()) {
...
<main class="container justify-content-center mx-auto mt-3">
	<div class="col-md-6 offset-md-3">
		<form class="form-signin mx-auto" method="post" action="recuperar.php">  
